...
train_dataset = MyDataset(train_encodings, list(train_label)).set_attrs(batch_size=256, shuffle=False)
...
for epoch_i in range(epoch):
	...
	pbar.close()
	jt.save(model.state_dict(), "256batchlstm_" + str(epoch_i) + ".pkl")
	train_loss += epoch_loss
	train_accuracies.append(accuracy)
result = {}
result["train_loss"] = train_loss
result["train_accuracies"]  = train_accuracies
json.dump(result, open("./256batchlstm_train_result.json", "w"))